...
help:
	@printf "$(CYAN)RodMCP Build System$(NC)\n"
	@printf "\n"
	@printf "$(YELLOW)Build Targets:$(NC)\n"
	@printf "  $(GREEN)build$(NC)           - Build the binary\n"
	@printf "  $(GREEN)clean$(NC)           - Clean build artifacts\n"
	@printf "  $(GREEN)rebuild$(NC)         - Clean and build\n"
	@printf "\n"
	@printf "$(YELLOW)Installation:$(NC)\n"
	@printf "  $(GREEN)install$(NC)         - Install system-wide (requires sudo, stops existing processes)\n"
	@printf "  $(GREEN)install-local$(NC)   - Install to user bin (recommended, no sudo, stops existing processes)\n"
	@printf "  $(GREEN)uninstall$(NC)       - Uninstall from system\n"
	@printf "  $(GREEN)stop-processes$(NC)  - Stop all running rodmcp processes\n"
	@printf "\n"
	@printf "$(YELLOW)Configuration:$(NC)\n"
	@printf "  $(GREEN)config-visible$(NC)  - Configure visible browser mode\n"
	@printf "  $(GREEN)config-headless$(NC) - Configure headless browser mode\n"
	@printf "\n"
	@printf "$(YELLOW)Development:$(NC)\n"
	@printf "  $(GREEN)test$(NC)            - Run tests\n"
	@printf "  $(GREEN)demo$(NC)            - Run demo\n"
	@printf "  $(GREEN)dev$(NC)             - Start development mode\n"
	@printf "  $(GREEN)check$(NC)           - Run all code quality checks\n"
	@printf "  $(GREEN)fmt$(NC)             - Format code\n"
	@printf "  $(GREEN)lint$(NC)            - Run linter\n"
	@printf "  $(GREEN)vet$(NC)             - Run go vet\n"
	@printf "\n"
	@printf "$(YELLOW)Dependencies:$(NC)\n"
	@printf "  $(GREEN)deps$(NC)            - Download dependencies\n"
	@printf "  $(GREEN)update-deps$(NC)     - Update dependencies\n"
	@printf "\n"
	@printf "$(YELLOW)Go Installation:$(NC)\n"
	@printf "  $(GREEN)check-go$(NC)        - Check Go installation status\n"
	@printf "  $(GREEN)install-go$(NC)      - Install Go locally (no sudo)\n"
	@printf "\n"
